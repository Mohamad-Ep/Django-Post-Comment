...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    """
    Custom User for Add fields and functions User
    """
    ...
    is_verified = models.BooleanField(
        default=False, verbose_name=_('تاییدشده/تایید نشده')
    )
...
class Profile(models.Model):
    """
    Profile class to add personal fields to User
    """

    user = models.OneToOneField(
        CustomUser, verbose_name=_("کاربر"), on_delete=models.CASCADE
    )
    ...
    GENDER_CHOICES = [("man", "مرد"), ("women", "زن")]
